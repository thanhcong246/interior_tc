...
public class ProductDiscountAdapter extends RecyclerView.Adapter<ProductDiscountAdapter.ViewHolder> {
    ...
    private ItemClickListenerDiscountProduct itemClickListenerDiscountProduct;

    public ProductDiscountAdapter(List<Product> productList) {
    ...
    public void setItemClickListenerHotProduct(ItemClickListenerDiscountProduct itemClickListenerDiscountProduct) {
        this.itemClickListenerDiscountProduct = itemClickListenerDiscountProduct;
    }
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (itemClickListenerDiscountProduct != null) {
                        int position = getAdapterPosition();
                        if (position != RecyclerView.NO_POSITION) {
                            Product product = productList.get(position);
                            itemClickListenerDiscountProduct.onItemClickDiscountProduct(product.getProduct_id());
                        }
                    }
                }
            });
    ...
    public interface ItemClickListenerDiscountProduct {
        void onItemClickDiscountProduct(int productId);
    }
}
